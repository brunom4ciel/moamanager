    ...
    public void input(double prediction) {
        ...
        if (prediction == 1.0) {
            ...
            if (m2s > m_m2smax) {
                ...
                // System.out.print(p + " ");
                if (m_n > this.minNumInstancesOption.getValue() && m_numErrors > m_minNumErrors
                        && p < this.outcontrolLevelOption.getValue()) {
                    //System.out.println(m_mean + ",D");
                    this.isChangeDetected = true;
                    //resetLearning();
                    //return DDM_OUTCONTROL_LEVEL;
                } else if (m_n > this.minNumInstancesOption.getValue()
                        && m_numErrors > m_minNumErrors && p < this.warningLevelOption.getValue()) {
