...
public class ADWINChangeDetector extends AbstractChangeDetector {
    ...
    public IntOption mintClockOption = new IntOption(
            "mintClock", 'm', "Interval between two detections.",
    ...
    public void resetLearning() {
        adwin = new ADWIN((double) this.deltaAdwinOption.getValue(), this.mintClockOption.getValue());
    }
