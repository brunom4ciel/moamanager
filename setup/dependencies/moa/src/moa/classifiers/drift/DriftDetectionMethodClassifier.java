...
public class DriftDetectionMethodClassifier extends AbstractClassifier {
    ...
    //protected ChangeDetector newDriftDetectionMethod;
   ...
   /* public boolean isWarningDetected() {
    ...
    public void resetLearningImpl() {
        ...
        //this.newDriftDetectionMethod = ((ChangeDetector) getPreparedClassOption(this.driftDetectionMethodOption)).copy();
        ...
        switch (this.ddmLevel) {
            case DDM_WARNING_LEVEL:
                ...
                if (newClassifierReset == true) {
                    ...
                    //this.newDriftDetectionMethod.resetLearning();
                }
                this.newclassifier.trainOnInstance(inst);
                //this.newDriftDetectionMethod.input(prediction ? 0.0 : 1.0);
                break;
            ...
            case DDM_OUTCONTROL_LEVEL:
                ...
                ChangeDetector aux = this.driftDetectionMethod;
                //this.driftDetectionMethod = this.newDriftDetectionMethod;
                //this.newDriftDetectionMethod = aux;
