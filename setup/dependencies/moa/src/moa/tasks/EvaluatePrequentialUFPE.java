...
public class EvaluatePrequentialUFPE extends MainTask {
    ...
    public MultiChoiceOption isDisssimilaryOption = new MultiChoiceOption(
			"isDisssimilary", 'm',
			"isDisssimilary?", new String[]{
...
//            "Metric Memory.");
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        flagValue = (isDisssimilaryOption.getChosenIndex() == 1 ? true:false);
        ddemeasures.setDISSIMILARITY(flagValue);
        ...
        for (int i = 1; i <= this.repetitionOption.getValue(); i++) {
            ...
            if(stream.getDriftPositions().size() > 0) {
                ...
                ddemetrics[indexMetrics].setDISSIMILARITY(ddemeasures.isDISSIMILARITY());
...
//                boolean preciseCPUTiming = TimingUtils.enablePreciseTiming();
            ...
            while (stream.hasMoreInstances()
                ...
                if(ddemeasures.isDISSIMILARITY()) {
