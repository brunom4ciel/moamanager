...
public class ConceptDriftRealStream extends AbstractOptionHandler implements
    ...
    protected InstanceStreamGenerators inputStream;

    protected InstanceStreamGenerators driftStream;
    ...
    public void prepareForUseImpl(TaskMonitor monitor,
        ...
        this.inputStream = (InstanceStreamGenerators) getPreparedClassOption(this.streamOption);
        this.driftStream = (InstanceStreamGenerators) getPreparedClassOption(this.driftstreamOption);
    ...
    public void changeRandomSeed( int value ) {
        this.inputStream.changeRandomSeed(value);
        this.driftStream.changeRandomSeed(value);
    }
    ...
    public List<Integer> getDriftPositions() {
        List<Integer> ans = this.inputStream.getDriftPositions();
        
        ans.add(this.positionOption.getValue());
    ...
    public List<Integer> getDriftWidths() {
        List<Integer> ans = this.inputStream.getDriftWidths();
        
        ans.add(this.widthOption.getValue());
