			...
			<div class="">
				...
				<div class="card" style="width: 100%">
					<div class="page-header">
						<h1>
							<a href="<?php echo $_SERVER['REQUEST_URI']?>"><?php echo TITLE_CONTROLLER_CPU;?></a>
						</h1>
					</div>
...
<?php echo $output;?>
							...
							<div id="console_cpu">
								...
								<div
									style="display: table; width: 87%; margin-left: auto; margin-right: auto;">
									<div id="disk">
										<div class='progress'>
							...
							<input type="button" value="Auto Refresh Usage"
							...
							<input type="button" value="Auto Refresh Process"
...
function refreshViewTempFiles(){
	...
	setTimeout(function () {
        ...
        if(cancelViewTempFiles==true){
            ...
            url = 'index.php?component=home&controller=temp_files_tmpl&task=view&tmpl=tmpl';
            method = 'POST';
            id = 'temp_files';
...
function refreshViewCPU(){
	...
	setTimeout(function () {
        ...
        if(cancelViewCPU==true){
            ...
            url = 'index.php?component=home&controller=cpu_tmpl&task=view&tmpl=tmpl';
            method = 'POST';
            id = 'console_cpu';
...
function refreshViewProcess(){
	...
	setTimeout(function () {
        ...
        if(cancelViewProcess==true){
        	...
        	url = 'index.php?component=home&controller=process_tmpl&task=view&tmpl=tmpl';
            method = 'POST';
            id = 'console_process';
