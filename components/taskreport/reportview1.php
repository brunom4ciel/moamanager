...
?>
							...
							<div class="page-header">
								...
								<input type="button"  class="btn btn-info"
									value="Trusted signature" name="trusted"
									onclick="javascript: trustedsignature();" />
...
$files_list = $utils->getListElementsDirectory1($dir, 
    // .DIRECTORY_SEPARATOR
    array(
        "txt"
    ));
                        ...
                        if($utils->isMetadataFileScript($file_real))
                        {
                            ...
                            {                                
                                $hash_file = $utils->checksumFileScriptMOA($file_real,
                                    PATH_USER_WORKSPACE_STORAGE, $element['script']);
