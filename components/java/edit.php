...
if ($filename != null) {
    ...
    $filename = Properties::getBase_directory_moa() . "src" 
    ...
    if ($task == "save") {
        ...
        $filenamenew = Properties::getBase_directory_moa() . "src" 
        . DIRECTORY_SEPARATOR . $folder . 
        // .DIRECTORY_SEPARATOR
							...
							<form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>"
								...
								<input type="hidden"
									...
									<div style="float: right; padding-left: 10px">
										...
										<input type="submit" class="btn btn-success" value="Save"> <input type="submit" class="btn btn-danger"
											value="Remove"
